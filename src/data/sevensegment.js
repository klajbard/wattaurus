  ...
  content: [
    {
      image: {
        ...
        url: "https://lh3.googleusercontent.com/pw/ACtC-3e8P4tA4d2v_sBQAFeVuhnmwHgRhr65S6bv_GSBuFMaEWVJ44lVq7FioSkxN4BpcoNZavQUAUX1CPH1DLMlIqev8_BTgq5H0F2R2scD1OQNg9TtwgKNsxtWtlDJIiRfAtU9gSMX1IRt_IP8nbHFz7Sy=w285-h380-no?authuser=0",
        avoidLazy: true,
        align: "left",
        caption: {
    ...
    {
      text: "To make the code more shorter and readable we can even use hexadecimal numbers. Use '0x00' instead of '00000000' or '0x2f' instead of '00101111'.",
      code: {
        source:
    ...
    },
    {
      ...
      image: {
        url: "https://lh3.googleusercontent.com/pw/ACtC-3cE-rsbxth3Z7gPiT_ee_d5zQZx21V_cpD7DEePwMdDvSM4bZiSxizmnTnGhHFopJ7-ibBeAyoz1Uy7upCndsJ0FvQBSWpIgRwoYqjnr7B75kbYWnW1jzXp8Gthfu7X5jK4D3oqSuK5N-aJe13obvN6=w1400-h700-no?authuser=0",
      ...
      text: "As said before in this example I will demonstrate the usage of the 7-segment display with a 4 digit board. The I2C protocol allows us to use minimalized amount of wires. Connect the display board to the Arduino based on the following.\n\n| _Adrduino Uno_ | _7-Segment Display_ |\n|:-:|:-:|\n| 5V | VCC |\n| GND | GND |\n| GPIO 8 | DIO |\n| GPIO 9 | CLK |",
    },
    {
      text: "The following snippet will simply create an infinite circle animation.",
      code: {
        source:
    ...
    {
      text: "After successfully uploading the code to the Arduino UNO, it should produce the following.",
    },
    {
      video: {
    ...
    {
      title: "Sum up",
      text: "7-Segment displays are really easy to set up and use yet very useful in various projects. Measure temperature or humidity, display current voltage or current, create a timer or a clock. The most challenging part could be that to calculate the binary value for the segments.",
    },
  ],
  time: 1608651131458,
};

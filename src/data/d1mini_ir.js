  ...
  content: [
    {
      image: {
        ...
        url: "https://lh3.googleusercontent.com/pw/ACtC-3dawsKSOLZILDxrGGwaJAZSzXL1fGnOpz0-k1bMKkH3eKW8_oBUwjXBCFTepkpOADv2IUhTzFvtR1XOpTOIMb2N3Dw6WVqPo8FOhXuEP8zmmzyhJ8kQ9A2FuQffFERv-ktN2Y5pp6zy021OSxa1yS6X=w1080-h540-no?authuser=0",
        avoidLazy: true,
        align: "none",
        style: {
          width: "100%",
    ...
    {
      title: "Configuration",
      text: "The next step is to define some environment specific global configuration like network settings, home assistant authorization and infrared receiver settings.",
    },
    {
    ...
    {
      text: "3. Finally add the configuration for the infrared receiver. It is required to specify a GPIO pin of the D1 Mini which will collect the data coming from the IR receiver. Using this PIN number instantiate the `IRrecv` class and `results` too.",
      code: {
        source:
    ...
    },
    {
      ...
      text: "As you might got used to it a `setup()` function is essential in each Arduino code. Here we define it as well. It initializes the Serial comminucation, and the IR receiver as well as connecting to the Wifi.",
      code: {
        source:
    ...
    {
      text: "The `connect_wifi()` function is a simple function which returns nothing, but tries to connect to the Wifi using the given credentials (`ssid`, `password`) and prints the current status to the Serial.",
      code: {
        source:
    ...
    },
    {
      ...
      text: "Previously we set up the board to process the incoming RF singals but it's also possible to send the board to deep sleep and wake up when receiving a signal. This should reduce a lot of power.\n",
    },
    {
      text: "1. First add some globals in the global scope which will helps us to create a cooldown counter. We want to make sure that after the board woke up all the signals are received and processed before going to deep sleep again. I've choose this to `5000 ms` which should be enough for this.",
      code: {
        source:
      ...
      image: {
        ...
        url: "https://lh3.googleusercontent.com/pw/ACtC-3eZ6ddDdiPEmI8inN2Y_8i-fuX5_rBzsv1sjAZJtTw2Fd6z7_65GQDo46ryGQt-5OaCW0cNuInFRmVzxjy6pcAlHaY6lEwfoiIwOFyW9xQcPX-eoexTHVRMMJ08kAQJrX-cWAERsIzLg5pEynGmwCCL=w825-h384-no?authuser=0",
        avoidLazy: true,
        align: "none",
        style: {
          width: "100%",
    ...
    {
      text: "3. Adjust the wiring by the following. The wiring is not that simple, containing in addition to the D1 mini and the IR receiver itself resistors as 1 kΩ. Used 1N4007 diode, BC547 transistor, 47uF capacitor in addition to the D1 mini and the IR receiver.",
    },
    {
      image: {
        alt: "Wiring D1 mini and IR receiver enabling deep sleep",
        url: "https://lh3.googleusercontent.com/pw/ACtC-3fPqV1XzJ85C9HbqKdM4dubg83FE-HdOU2svoayNHBRKMRHwM5xs1tg_IV1FoA5jwalbQpXW2bCa07IrScKdozf5CY2REvDZKF_yakaVr5PzPSoptvxYZKh0FAMzrBkApHjqu0lvq7CsdMQ7uAgLLNM=w1255-h628-no?authuser=0",
        avoidLazy: true,
        align: "none",
        style: {
          width: "100%",
    ...
    {
      title: "Conclusion",
      text: "This was one of my most exciting project recently. This helped me to get a closer look on how transistors and capacitors work. They really opened a whole new world. Also this small project will be surely the part of my home automation system.",
    },
  ],
  time: 1604780370000,
};

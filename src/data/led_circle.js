export default {
  ...
  content: [
    ...
    },
    {
      ...
      text:
        "The next function receives 3 parameters as red, green and blue levels of a color. It first lights up the first pixel and go through the full circle creating a tail behind. In the tail each next color has the color levels halved.",
      video: {
    ...
    {
      text:
        "The following snippet stores 12 colors of the rainbow and iterates through it. The function maintains the order of the colors and rotate one pixel in each iteration.",
      video: {
        alt: "Pixel running in circle",

  ...
  content: [
    {
      ...
      image: {
        ...
        url: "https://lh3.googleusercontent.com/pw/ACtC-3f1RCV4LDHa_F4_7Udq8RvxmqH_AvZvN5eP-MlTBTmyvinxQDnPMYqdoE8IL6dvkd24nJHRGSxjIRX1dmGKNgQHLMalOv4BFQwDzetYxXLSXXeHl-q4Bc0ZjcsC-z_zJehS93VGXqQgFn4lz8LmASd9=w1000-h500-no",
        avoidLazy: true,
        align: "none",
        caption: {
    ...
    },
    {
      ...
      text: 'More comfortable way is to simply copy data from SD Card to SSD using Raspberry. It will copy all data and create a bootable SSD. It is now time to plug in the USB device which you want to boot from. If the board allows make sure to plug it into an USB 3 port. Go to "Start Menu" search for "Accessories" and open "SD Card Copier" software. The **SD Card Copier** can backup existing Rasperry OS installation. In addition it, is also a great tool to directly run the Pi from a backup card or USB device if the original somehow got corrupted. In this case simply reverse the process. Just bear in mind that on the destination card or USB device everything will be overwritten.',
    },
    {
      image: {
        alt: "Copy from SD Card to SSD",
        url: "https://lh3.googleusercontent.com/pw/ACtC-3enyzeA9nM6bmUwemTYadeqT7sc9f6sjRfLBSzi-oLbLdahjdudMICor_Px52sjUfjzFDx3LM8Zd0m1xFCOllnkX2iS8ih1JjfrObPnJ_nz_CvQnTVS6nk-RhGQsv2fG8pLQ_DiIXbIsv4oH1XE7ox2=w322-h142-no",
        avoidLazy: true,
        align: "left",
        caption: {
      ...
      text: 'To copy over files pick SD Card from the "Copy From Device" dropdown and choose the SSD from the "Copy To Device". Click on "Start" and choose "Yes" to overwrite existing data when prompted. It usually takes 3-5 minutes to copy. Once it\'s done shutdown the Pi, remove the SD Card from it and boot it.',
    },
    {
      title: "Conclusion",
      text: "You should feel the speed already. It should boot much faster than before. Remember to regularly do a backup of your system (or at least the useful part) because switching from SD Card to SSD doesn't eliminate the possibility for potential data loss.",
    },
  ],
  time: 1601282110000,
};

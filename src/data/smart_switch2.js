  ...
  content: [
    {
      image: {
        alt: "Homeassistant",
        url:
          "https://lh3.googleusercontent.com/pw/ACtC-3eFWPBjGkoEFROPJQToyF9V2KAaNtyfO14qXkC9VJXAtSA9QAvcXyDRnlgp4gSYC4oozMe33huPNIVxHY_GJrRHgjWHTfHJnJX36traGgWJAmm5bfGctA3kTq1noL6f5TxWKZpr-6RmDpAGmMEMzS-L=w720-h360-no",
        avoidLazy: true,
        align: "none",
        style: {
          width: "100%",
    ...
    {
      text:
        "After a quick restart in Home Assistant we are now able to add the switch(`switch.powr2`) to the dashboard and start switching on/off and also add state sensors as `sensor.powr2_current` and `sensor.powr2_today`.",
    },
  ],
  time: 1600527323000,
};

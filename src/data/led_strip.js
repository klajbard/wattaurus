export default {
  ...
  content: [
    ...
    },
    {
      ...
      text: "The WS2812 has 3 pins VCC, GND and DAT. Connect VCC and GND to external power source and DAT to D7 pin. By this time we are able to initialize the LED as CRGB by the following code snippet.",
    },
    {
      code: {
        source:

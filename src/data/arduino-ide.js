  ...
  content: [
    {
      image: {
        ...
        url:
          "https://lh3.googleusercontent.com/pw/ACtC-3doWllAGs4GJbIp_XRRY2G1j49U6bZEQ3SQKtWf-fUw08bddM5DrXccEqm7C0Z2bmaEmlkad_B460JiK93OSm_1ErQb09zmQuoAZSbVyw3BCVD6XUX971TAaCGMiui5BdCTG7DN5zBqD1Vlg5jNjC_V=s953-no?authuser=0",
        avoidLazy: true,
        align: "left",
        caption: {
    ...
    {
      text:
        'Copy the following code snippet and paste it to your _Arduoino IDE_. Hit **"File -> Save"**(**CTRL+S**) and **"Sketch -> Upload"**(**CTRL+U**). It could take up to 30 seconds. If everything went smooth, the board will now restart and boots with the freshly burned program. In our case it will just prints to the serial output.',
    },
    {
      video: {

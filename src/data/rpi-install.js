export default {
  ...
  content: [
    ...
    },
    {
      title: "Enable VNC",
      text:
        "By most of the time SSH is more than enough to access the Raspberry but there are situations when GUI is required. Of course you can already have the desktop if you connect a display to the Pi, but most of the times you won't. VNC allows remote control of a computer which is available on the Pi. To allow incoming connection we should first **enable VNC Server** it in the `raspi-config` settings.",
    },
    {
      video: {
        alt: "Burning RPi OS to SD Card",

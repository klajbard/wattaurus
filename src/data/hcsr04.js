  ...
  content: [
    {
      image: {
        ...
        url: "https://lh3.googleusercontent.com/pw/ACtC-3eXBHEpNn4GCvgnABnTV24fnBh6j7QmK-LwcIl1mTbht61iSbHi_KceAxnmFwXhU8oPrMYXi05SKhbjlcunr3jqHF_AWieq2obiiIsQ--qUzl2SmjS3wnvixnQCheuLpwOmZHwIbV8fU-8pZDsyMCKc=w1080-h540-no?authuser=0",
    ...
    {
      title: "Let's code",
      text: "We now had a closer look on how the ultrasonic sensor works. Let's have some actual coding! All we have to do now is to have a written form of all the previous theoretical knowledge. The beauty of it is that no third party library is needed.",
      code: {
        source:
    ...
    {
      title: "Conclusion",
      text: "The use of HC-SR04 sensor also makes it possible to gather some additional knowledge about sound waves and some basic physics. These sensor are able to detect the distance between two objects so it's perfect for basic self automated cars, robots and automation triggers.",
    },
  ],
  time: 1609245866316,
};
